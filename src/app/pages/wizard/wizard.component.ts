...
export class WizardComponent implements OnInit {
  ...
  @ViewChild('stepper') stepper: MatStepper;//para validar antes de pasar al siguiente paso
  ...
  consultorios: number[] = [];//selecionan los consultorios
  consultorioSeleccionado: number = 0;

  constructor(
    private formBuilder: FormBuilder, //para agrupar el formgr1 y formgrup2 
  ...
  nextManualStep() {//controlar el stept
  ...
  limpiarControles() {
    ...
    this.mensaje = '';
    this.stepper.reset();//del ultimo paso al primer paso
  }
